...
pub const LIST: &[(&'static str, &'static str, i32)] = &[
    ("ヴョ", "ヴョ", 1),
    ("ヴュ", "ヴュ", 1),
    ("ヴャ", "ヴャ", 1),
    ("ヴォ", "ヴォ", 1),
...
pub const LIST_FROM: Lazy<Vec<&str>> = Lazy::new(|| {
    LIST
        .iter()
        .map(|(from, _to, _mora_size)| *from)
        .collect()
});

pub const LIST_AHO_CORASICK: Lazy<AhoCorasick> = Lazy::new(|| {
    AhoCorasickBuilder::new()
        .match_kind(MatchKind::LeftmostLongest)
        .build(LIST_FROM.deref())
});