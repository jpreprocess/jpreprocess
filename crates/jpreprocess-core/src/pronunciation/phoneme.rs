...
pub(crate) fn mora_to_phoneme(mora: &Mora) -> (Option<Consonant>, Option<Vowel>) {
    let (consonant, vowel) = match mora.mora_enum {
        ...
        MoraEnum::Ri => (Some(Consonant::Ry), Some(Vowel::I)),
        ...
        MoraEnum::Mi => (Some(Consonant::My), Some(Vowel::I)),
        ...
        MoraEnum::Pi => (Some(Consonant::Py), Some(Vowel::I)),
        ...
        MoraEnum::Bi => (Some(Consonant::By), Some(Vowel::I)),
        ...
        MoraEnum::Hi => (Some(Consonant::Hy), Some(Vowel::I)),
        ...
        MoraEnum::Ni => (Some(Consonant::Ny), Some(Vowel::I)),
        ...
        MoraEnum::Gi => (Some(Consonant::Gy), Some(Vowel::I)),
